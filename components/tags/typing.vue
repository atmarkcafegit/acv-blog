<template>
  <span :class="klass.gap" @click="$emit('click')">
    <input type="text" :class="klass.input" :style="{width: baseWidth + charLen(text) + 'ch'}" ref="input"
           v-model="text" @mousedown="preventNativeActive" @blur="finishEditing" @keydown="keyPress"/>
